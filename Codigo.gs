// Painel Operacional Confiança v6.10
...
function syncInfo_(){
  ...
  return {status:"ok",versao:"v6.10",revision:digest,servidorEm:Utilities.formatDate(new Date(),Session.getScriptTimeZone(),"yyyy-MM-dd'T'HH:mm:ss")};
}
